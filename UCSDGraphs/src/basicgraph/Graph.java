...
public abstract class Graph {
	...
	public static void main (String[] args) {
		...
		System.out.println("****");
		System.out.println("Goal 1: implement method using AdjacencyList approaches.");
		System.out.println("Roads / intersections:");
		GraphAdjList graphFromFile1 = new GraphAdjList();
		GraphLoader.loadRoadMap("data/maps/ucsd.map", graphFromFile1);
		for(int i=0;i<graphFromFile1.getNumVertices();i++) {
			List<Integer> twoHop = graphFromFile1.getDistance2(i);
			System.out.println(i + " => " + twoHop);
		}
		System.out.println("****");
		System.out.println("Goal 2: implement method using AdjacencyMatrix approaches.");
		GraphAdjMatrix graphFromFile2 = new GraphAdjMatrix();
		GraphLoader.loadRoadMap("data/maps/ucsd.map", graphFromFile2);
		for(int i=0;i<graphFromFile2.getNumVertices();i++) {
			List<Integer> twoHop = graphFromFile2.getDistance2(i);
			System.out.println(i + " => " + twoHop);
		}
