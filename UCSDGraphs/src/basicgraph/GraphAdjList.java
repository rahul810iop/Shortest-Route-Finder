...
public class GraphAdjList extends Graph {
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 List<Integer> neighbors_hop2 = new ArrayList<Integer>();
		 ArrayList<Integer> check = adjListsMap.get(v);
		 for(int i : check) {
		 ArrayList<Integer> check_2 = adjListsMap.get(i);	 
			 for(int j : check_2) {
				 neighbors_hop2.add(j);
			 }
		 }
		 return neighbors_hop2;
	}
